            ...
            <div className='max-w-2xl mx-auto px-4 sm:px-6'>
                ...
                <form onSubmit={handleSubmit} className='flex gap-3'>
                    <div className='flex-1 relative'>
                        <input type="text" value={searchInput} onChange={(e)=>{setSearchInput(e.target.value)}} placeholder='Enter city name...' className='w-full px-6 py-4 rounded-lg bg-white border-0 focus:ring-2' />
                    </div>
