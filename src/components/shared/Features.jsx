...
const Features = () => {
    ...
    const featuresData = [
        {
        ...
        },
          {
            ...
            description: 'Experience lighning-fast weather updates with our optimized data retrival system, ensuring you get the information you need without delay.'
        },
          {
  ...
  return (
   <section className='px-4 md:px-8 lg:px-20 py-10 lg:py-20 bg-gray-100'>
        ...
        {/* heading    */}
        <div>
            <h2 className='text-center text-5xl font-bold mb-10'>Features</h2>
            <p className='text-lg text-center'>Our features that we provide.</p>
        </div>
