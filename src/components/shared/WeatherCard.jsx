...
const WeatherCard = ({weather}) => {
  return (
    <div className='border rounded-2xl border-gray-300 shadow-lg overflow-hidden'>
      ...
      {/* header */}
      <div className='bg-linear-to-r from-purple-900 to-blue-200 text-white'>
      ...
      <div className='p-8'>
        <div className='grid grid-cols-2 lg:grid-cols-4'>
          ...
          <div className='flex flex-col items-center text-center'>
              ...
              <p className='text-2 font-bold'>{weather.relative_humidity_2m}%</p>
          </div>

          <div className='flex flex-col items-center text-center'>
              <Wind className='w-8 h-8 mb-3'/>
              <p className='text-sm mb-1'>Wind Speed</p>
              <p className='text-2 font-bold'>{weather.wind_speed_10m} mph</p>
          </div>

          <div className='flex flex-col items-center text-center'>
              <Eye className='w-8 h-8 mb-3'/>
              <p className='text-sm mb-1'>Visibility</p>
              <p className='text-2 font-bold'>{weather.visibility} m</p>
          </div>

          <div className='flex flex-col items-center text-center'>
              <Cloud className='w-8 h-8 mb-3'/>
              <p className='text-sm mb-1'>Pressure</p>
              <p className='text-2 font-bold'>{weather.pressure_msl} mb</p>
          </div>
